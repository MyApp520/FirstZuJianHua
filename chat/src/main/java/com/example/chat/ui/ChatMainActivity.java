...
public class ChatMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "ChatMainActivity onCreate: 主线程 = " + Thread.currentThread().getName() + ", id = " + Thread.currentThread().getId());
        Log.e(TAG, "ChatMainActivity onCreate: userBean = " + userBean);
    }
